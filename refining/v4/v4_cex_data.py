...
def fetch_coinbase_prices(product_id, start_iso, end_iso, granularity=60):
    ...
    print(f"Querying: {start_iso} to {end_iso} → got {len(data)} candles")

    return df.sort_values("timestamp_unix")


def fetch_all_prices(start_time, end_time, product_id="ETH-USD"):
...
# start = datetime.fromisoformat("2025-05-05T00:00:00")
# end = datetime.fromisoformat("2025-05-06T00:00:00")
